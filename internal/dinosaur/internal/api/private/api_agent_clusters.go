...
*/
func (a *AgentClustersApiService) GetDinosaurs(ctx _context.Context, id string) (ManagedDinosaurList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ManagedDinosaurList
	)
...
*/
func (a *AgentClustersApiService) UpdateDinosaurClusterStatus(ctx _context.Context, id string, requestBody map[string]DataPlaneDinosaurStatus) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
